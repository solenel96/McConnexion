...
let utils = {
    ...
    subscribeBrick: (brickId, eventName, cb) => {
        ...
        utils.io.emit("subscribeBrick", { brickId: brickId,
            eventName: eventName,
    ...
    XHR: (method, ad, params) => {
        ...
        return new Promise(function (resolve, reject) {
            ...
            params = params || {};
            xhr.onload = function () { if (this.status >= 400) {
                reject(this);
            }
            else {
                resolve(this);
